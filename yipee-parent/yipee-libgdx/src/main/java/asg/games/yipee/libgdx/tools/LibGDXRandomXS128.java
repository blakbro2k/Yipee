 ...
 * @author davebaol
 */
public class LibGDXRandomXS128 extends Random {
    private static final Logger logger = Logger.getLogger(LibGDXRandomXS128.class.getSimpleName());
     ...
     */
    public LibGDXRandomXS128(long seed) {
        setSeed(seed);
    }
     ...
     */
    public LibGDXRandomXS128(long seed0, long seed1) {
