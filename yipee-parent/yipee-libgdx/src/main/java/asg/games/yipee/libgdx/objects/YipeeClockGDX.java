...
/**
 * The {@link YipeeClockGDX} class represents a timer for tracking elapsed time in the Yipee game.
...
public class YipeeClockGDX extends AbstractYipeeObjectGDX {
