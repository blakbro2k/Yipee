...
public class YipeeBlockGDX extends AbstractYipeeObjectGDX implements Disposable {
     ...
     */
    public YipeeBlockGDX(int x, int y, int blockType) {
        reset();
        this.x = x;
        this.y = y;
     ...
     * @param y the Y-coordinate of the block
     */
    public YipeeBlockGDX(int x, int y) {
    ...
    public static String printReaderFriendlyBlock(int block) {
        if (block == YipeeBlockGDX.CLEAR_BLOCK) {
            ...
            if (YipeeBlockEvalGDX.hasPowerBlockFlag(block)) {
                return "" + YipeeBlockEvalGDX.getPowerLabel(block); // Power block representation
            } else {
                return "" + YipeeBlockEvalGDX.getNormalLabel(block); // Normal block representation
            }
        }
    }
    ...
    public String toString() {
        return super.toString() + "{block: [" + blockType + "]" +
            YipeeBlockGDX.printReaderFriendlyBlock(blockType) + "}";
    }
