...
public class YipeeKeyMapGDX implements Copyable<YipeeKeyMapGDX>, Disposable, YipeeSerializable {
     ...
     */
    private final ObjectMap<PlayerAction.ActionType, Integer> actionToKeycode = GdxMaps.newObjectMap();
     ...
     */
    public YipeeKeyMapGDX(String playerId) {
     ...
     */
    public ObjectMap<PlayerAction.ActionType, Integer> getAllBindings() {
        return actionToKeycode;
    }
     ...
     */
    @Override
    public YipeeKeyMapGDX deepCopy() {
        YipeeKeyMapGDX copy = new YipeeKeyMapGDX(this.playerId);
    ...
    public PlayerAction.ActionType getActionForKey(int keycode) {
        ...
        for (ObjectMap.Entry<PlayerAction.ActionType, Integer> entry : actionToKeycode.entries()) {
            if (entry.value == keycode) return entry.key;
        }
        return null;
    }
}
